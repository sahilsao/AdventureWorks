...
namespace AdventureWorks.Data
{
    ...
    {
        private IAdventureWorksContextProcedures _procedures;

        public virtual IAdventureWorksContextProcedures Procedures
        {
            get
            {
                if (_procedures is null) _procedures = new AdventureWorksContextProcedures(this);
                return _procedures;
            }
            set
            {
        ...
        public IAdventureWorksContextProcedures GetProcedures()
        {
            return Procedures;
        }
    }

    public partial class AdventureWorksContextProcedures : IAdventureWorksContextProcedures
    {
        private readonly AdventureWorksContext _context;

        public AdventureWorksContextProcedures(AdventureWorksContext context)
        {
            _context = context;
        }
